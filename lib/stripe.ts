...
// For server-side
const stripeSecretKey = process.env.STRIPE_SECRET_KEY || 'sk_test_51QKzcxDSLnjOQfn7zEwTgdSFA9AHq4glfmNnALQXIoUM3UPbPNuQueelpoYjrSgliLFbio4TrljYoOCsFBJxkTlE0001F9R7Y5x';
